<template>
  <div class="houses-page">
        ...
        <thead>
          <tr>
            ...
            <th
              ...
              scope="col"
              class="houses-page__actions-col"
            ></th>
          </tr>
        </thead>
        <tbody>
    ...
    <item-modal
      :params="modalProps"
      v-if="modalShow && canCreate"
      @close="closeModal"
    >
      <form class="validated-form mb-5">
        <div
          class="mb-3 validated-form__field"
        ...
        <div class="houses-page__error" v-if="!valid">
          Форма заполнена не верно
        </div>
      </form>
      <button class="btn btn-primary me-2" @click="closeModal">Close</button>
      <button class="btn btn-success" @click="submit(modalParams.id)">
        Submit
      </button>
    </item-modal>
